...
class AlbumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create album" do
    assert_difference('Album.count') do
      post albums_url, params: { album: { album_title: @album.album_title, name: @album.name } }
    end
  ...
  test "should update album" do
    patch album_url(@album), params: { album: { album_title: @album.album_title, name: @album.name } }
